...
{   
    virtual void Vuforia_onUpdate(Vuforia::State& /*state*/)
    {
        if (switchDataSetAsap)
        {
            ...
            if (objectTracker == 0 || dataSetWine == 0 || dataSetTarmac == 0 ||
            ...
            {
                case WINE_ID:
                    if (objectTracker->getActiveDataSet() != dataSetWine)
                    {
                        objectTracker->deactivateDataSet(dataSetTarmac);
                        objectTracker->activateDataSet(dataSetWine);
                    }
                    break;
                ...
                case TARMAC_DATASET_ID:
                    ...
                    {
                        objectTracker->deactivateDataSet(dataSetWine);
...
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_setActivityPortraitMode(JNIEnv *, jobject, jboolean isPortrait)
{
...
JNIEXPORT void JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_switchDatasetAsap(JNIEnv *, jobject, jint datasetId)
{
...
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_initTracker(JNIEnv *, jobject)
{
    LOG("Java_ru_shtrm_ariant_ImageTargets_ImageTargets_initTracker");
...
JNIEXPORT void JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_deinitTracker(JNIEnv *, jobject)
{
    LOG("Java_ru_shtrm_ariant_ImageTargets_ImageTargets_deinitTracker");
...
JNIEXPORT int JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_loadTrackerData(JNIEnv *, jobject)
{
    LOG("Java_ru_shtrm_ariant_ImageTargets_ImageTargets_loadTrackerData");
    ...
    dataSetWine = objectTracker->createDataSet();
    if (dataSetWine == 0)
    {
    ...
    // Load the data sets:
    if (!dataSetWine->load("wine.xml", Vuforia::STORAGE_APPRESOURCE))
    {
    ...
    if (!objectTracker->activateDataSet(dataSetWine))
    {
...
JNIEXPORT int JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_destroyTrackerData(JNIEnv *, jobject)
{
    LOG("Java_ru_shtrm_ariant_ImageTargets_ImageTargets_destroyTrackerData");
    ...
    if (dataSetWine != 0)
    {
        ...
        if (!objectTracker->destroyDataSet(dataSetWine))
        {
...
JNIEXPORT void JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_onVuforiaInitializedNative(JNIEnv *, jobject)
{
...
JNIEXPORT void JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargetsRenderer_renderFrame(JNIEnv *, jobject)
{
...
JNIEXPORT void JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_initApplicationNative(
                            JNIEnv* env, jobject obj, jint width, jint height)
{
    LOG("Java_ru_shtrm_ariant_ImageTargets_ImageTargets_initApplicationNative");
    ...
    jmethodID getTextureMethodID = env->GetMethodID(activityClass,
        "getTexture", "(I)Lru/shtrm/ariant/ImageTargets/Texture;");
    ...
    LOG("Java_ru_shtrm_ariant_ImageTargets_ImageTargets_initApplicationNative finished");
}


JNIEXPORT void JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_deinitApplicationNative(
                                                        JNIEnv* env, jobject obj)
{
    LOG("Java_ru_shtrm_ariant_ImageTargets_ImageTargets_deinitApplicationNative");
...
JNIEXPORT void JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_startCamera(JNIEnv *,
                                                                         jobject, jint camera)
{
    LOG("Java_ru_shtrm_ariant_ImageTargets_ImageTargets_startCamera");
...
JNIEXPORT void JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_stopCamera(JNIEnv *, jobject)
{
    LOG("Java_ru_shtrm_ariant_ImageTargets_ImageTargets_stopCamera");
...
JNIEXPORT void JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargetsRenderer_updateRenderingPrimitives(JNIEnv *, jobject)
{
    LOG("Java_ru_shtrm_ariant_ImageTargets_ImageTargetsRenderer_updateRenderingPrimitives");
...
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_activateFlash(JNIEnv*, jobject, jboolean flash)
{
    return Vuforia::CameraDevice::getInstance().setFlashTorchMode((flash==JNI_TRUE)) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_autofocus(JNIEnv*, jobject)
{
...
JNIEXPORT jboolean JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_setFocusMode(JNIEnv*, jobject, jint mode)
{
    int focusMode;
...
JNIEXPORT jboolean JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_startExtendedTracking(JNIEnv*, jobject)
{
    Vuforia::TrackerManager& trackerManager = Vuforia::TrackerManager::getInstance();
    Vuforia::ObjectTracker* objectTracker = static_cast<Vuforia::ObjectTracker*>(
          trackerManager.getTracker(Vuforia::ObjectTracker::getClassType()));
...
JNIEXPORT jboolean JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargets_stopExtendedTracking(JNIEnv*, jobject)
{
    Vuforia::TrackerManager& trackerManager = Vuforia::TrackerManager::getInstance();
    Vuforia::ObjectTracker* objectTracker = static_cast<Vuforia::ObjectTracker*>(
          trackerManager.getTracker(Vuforia::ObjectTracker::getClassType()));
...
JNIEXPORT void JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargetsRenderer_initRendering(
                                                    JNIEnv* env, jobject obj)
{
    LOG("Java_ru_shtrm_ariant_ImageTargets_ImageTargetsRenderer_initRendering");
...
JNIEXPORT void JNICALL
Java_ru_shtrm_ariant_ImageTargets_ImageTargetsRenderer_updateRendering(
                        JNIEnv* env, jobject obj, jint width, jint height)
{
    LOG("Java_ru_shtrm_ariant_ImageTargets_ImageTargetsRenderer_updateRendering");
