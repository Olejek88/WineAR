...
public class AriantApplicationSession implements UpdateCallbackInterface
{
    
    private static final String LOGTAG = "Ariant";
    
    // Reference to the current activity
    private Activity mActivity;
    private AriantApplicationControl mSessionControl;
    ...
    public AriantApplicationSession(AriantApplicationControl sessionControl)
    {
    ...
    {
        AriantApplicationException vuforiaException = null;
        mActivity = activity;
        ...
        if (mInitVuforiaTask != null)
        {
            ...
            vuforiaException = new AriantApplicationException(
                AriantApplicationException.VUFORIA_ALREADY_INITIALIZATED,
                logMessage);
        ...
        if (vuforiaException == null)
        {
            ...
            } catch (Exception e)
            {
                ...
                vuforiaException = new AriantApplicationException(
                        AriantApplicationException.INITIALIZATION_FAILURE,
                    logMessage);
                Log.e(LOGTAG, logMessage);
            }
        }
    ...
    public void startAR(int camera) throws AriantApplicationException
    {
        String error;
        if(mCameraRunning)
        {
        	...
        	Log.e(LOGTAG, error);
            throw new AriantApplicationException(
                    AriantApplicationException.CAMERA_INITIALIZATION_FAILURE, error);
        }
    ...
    public void stopAR() throws AriantApplicationException
    {
        ...
        synchronized (mShutdownLock)
        {
            ...
            if (!unloadTrackersResult)
                throw new AriantApplicationException(
                        AriantApplicationException.UNLOADING_TRACKERS_FAILURE,
                    "Failed to unload trackers\' data");
            
            if (!deinitTrackersResult)
                throw new AriantApplicationException(
                        AriantApplicationException.TRACKERS_DEINITIALIZATION_FAILURE,
    ...
    public void resumeAR() throws AriantApplicationException
    {
    ...
    public void pauseAR() throws AriantApplicationException
    {
        if (mStarted)
        {
            stopCamera();
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "");
            ...
            if (result)
            {
                ...
                if (initTrackersResult)
                {
                    ...
                    } catch (Exception e)
                    {
                        ...
                        vuforiaException = new AriantApplicationException(
                                AriantApplicationException.LOADING_TRACKERS_FAILURE,
                            logMessage);
                        Log.e(LOGTAG, logMessage);
                        mSessionControl.onInitARDone(vuforiaException);
                    }
                ...
                {
                    vuforiaException = new AriantApplicationException(
                            AriantApplicationException.TRACKERS_INITIALIZATION_FAILURE,
    ...
    private class LoadTrackerTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            } else
            {
                ...
                Vuforia.registerCallback(AriantApplicationSession.this);
